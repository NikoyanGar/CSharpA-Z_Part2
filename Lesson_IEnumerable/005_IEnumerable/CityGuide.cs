...
{
    class CityGuide : IEnumerable<Attraction>, IEnumerable
    {
        ...
        {
            yield return attractions[0];
            yield return attractions[1];
            yield return attractions[1];
            //yield return "new";
            //yield return 1;
            // yield return null;
        ...
        IEnumerator IEnumerable.GetEnumerator()
        {
            ...
            yield return attractions[1];
            yield return attractions[1];
            yield return new Attraction(1, "Metropolitan Museum of Art", "World-class art collection", "Museum", 1, 0);
            yield return "new";
            yield return 1;
            //for (int i = 0; i < attractions.Length; i++)
            //{
            //    yield return attractions[i];
            //}
        }
    }
}
